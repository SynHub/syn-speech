...
namespace Syn.Speech.Util
{
    ...
    /// </summary>
    public class PooledBatchManager: IBatchManager
    {
    ...
    //    private static File inputDir = new File(topDir, "ToRun");
    //    private static File inProcessDir = new File(topDir, "InProcess");
    //    private static File completedDir = new File(topDir, "Completed");
    //    private static File resultsDir = new File(topDir, "Results");
    //    private static File lockFile = new File(".lock");
