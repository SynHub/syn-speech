...
namespace Syn.Speech.FrontEnds
{
    ...
    public class FrontEnd : BaseDataProcessor
    {
        ...
        public static string PropPipeline = "pipeline";

        // ----------------------------
        // Configuration data
        // -----------------------------
        private List<IDataProcessor> _frontEndList;
        private Timer _timer;

        private IDataProcessor _first;
        private readonly List<ISignalListener> _signalListeners = new List<ISignalListener>();

        public FrontEnd(List<IDataProcessor> frontEndList)
        {
            this._frontEndList = frontEndList;
            Init();
        }
        ...
        {
            _timer.Start();
            IData data = LastDataProcessor.GetData();
        ...
        {
            foreach (ISignalListener listener in _signalListeners)
        ...
        /// </summary>
        /// <value></value>
        public IDataProcessor LastDataProcessor { get; private set; }

        /// <summary>
        /// Returns a description of this FrontEnd in the format: <front end name> {<DataProcessor1>, <DataProcessor2> ...<DataProcessorN>}
        /// </summary>
        /// <returns>
        ...
        public override string ToString()
        {
            ...
            for (IDataProcessor current = LastDataProcessor; current != null; current = current.Predecessor)
