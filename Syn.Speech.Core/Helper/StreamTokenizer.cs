...
namespace Syn.Speech.Helper
{
    ...
    /// and then repeatedly loops calling the nextToken method in each iteration of the loop until it returns the value TT_EOF.
    ...
    public class StreamTokenizer : IEnumerable<int>
    {
        ...
        private readonly List<char> _bufferList = new List<char>();
        ...
        public StreamTokenizer(String stringRead)
            : this()
        {
            _reader = null;
        }
        ...
        private int Read()
        {
            ...
            else
            {
                ...
                {
                    return _bufferIndex>_buffer.Length-1?-1:_buffer[_bufferIndex++];
                }
        ...
        public int NextToken()
        {
            ...
            if ((ctype & CtAlpha) != 0)
            {
                ...
                _peekc = c;
                StringValue = new string(_bufferList.ToArray(), 0, i);
                if (_forceLower)
