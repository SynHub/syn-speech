...
namespace Syn.Speech.Helper.Mathematics.Stat.Descriptive.Summary
{
 ...
 *
 */
public class Sum : AbstractStorelessUnivariateStatistic , ISerializable {
    ...
    public override UnivariateStatistic copy() //Todo: Supposed to be public override Sum copy()
    {
        Sum result = new Sum();
