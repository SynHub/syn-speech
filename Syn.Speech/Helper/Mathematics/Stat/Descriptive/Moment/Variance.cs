...
/// </summary>
public class Variance : AbstractStorelessUnivariateStatistic , ISerializable,  WeightedEvaluation {
     ...
     */
    private bool _isBiasCorrected = true;
     ...
     */
    public double evaluate( double[] values,  double[] weights,
     double mean,  int begin,  int length) {
    ...
    public void setBiasCorrected(bool biasCorrected) {
        _isBiasCorrected = biasCorrected;
    }
